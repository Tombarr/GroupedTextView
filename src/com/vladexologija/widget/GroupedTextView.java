...
public class GroupedTextView extends LinearLayout {
	 ...
	 * @param text
	 */
	public void addPlainTextView(int textId) {	
		addPlainTextView(context.getResources().getString(textId));
	}
	 ...
	 * @param text
	 */
	public void addPlainTextView(String label, String text) {		
		PlainTextView item = new PlainTextView(context);
		item.setLabel(label);
		item.setText(text);	
	 ...
	 * @param text
	 */
	public void addPlainTextView(int labelId, String text) {
		addPlainTextView(context.getResources().getString(labelId), text);
	}
	 ...
	 * @param text
	 */
	public void addPlainTextView(int labelId, int textId) {
		addPlainTextView(context.getResources().getString(labelId),
